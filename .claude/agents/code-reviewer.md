...
4. **Report:** Provide structured feedback with severity (must-fix / should-fix / nice-to-have), file and line references, and concrete improvement suggestions.
5. **Save Memory:** Update `.claude/agent-memory/code-reviewer/MEMORY.md` with new patterns.

# Guidelines
- **Never modify source code.** Your output is a review report.
